...
assert_file "$project/adapters/agy/parser.php"
assert_file "$project/adapters/agy/policy.php"
assert_file "$project/adapters/agy/contract.md"
...
assert_not_file "$project/adapters/agy/runner.sh"
assert_not_file "$project/adapters/agy/parser.php"
assert_not_file "$project/adapters/agy/policy.php"
assert_not_file "$project/adapters/agy/contract.md"
assert_not_file "$project/.agents/agents/ralph-review/agent.md"
assert_not_file "$project/.ralph/agy.env"
